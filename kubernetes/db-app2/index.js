...
const monogoHost = process.env.MONGO_HOST || 'localhost';
const mongoPort = process.env.MONGO_PORT || '27017';
const mongoDbName = process.env.MONGO_DB_NAME || 'yourDatabaseName';

// Connect to MongoDB
mongoose.connect(`mongodb://${monogoHost}:${mongoPort}/${mongoDbName}`, {
